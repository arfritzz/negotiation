...
and threat mitigation. In summary, the goal of ISAKMP is for transferring key
...
\begin{enumerate}
	\item 
		\begin{verbatim} https://books.google.com/books?id=w2u6a_NZr_8C&pg=PA164&lpg=PA164&dq=ISAKMP+header&source=bl&ots=x45AtA8F2x&sig=ACfU3U3zxANfosIM-H-jKpBOKrrXsHxyxg&hl=en&sa=X&ved=2ahUKEwir_IeR3IDkAhXZW80KHczVD0YQ6AEwE3oECA8QAQ#v=onepage&q=ISAKMP%20header&f=false
		\end{verbatim}
\end{enumerate}
