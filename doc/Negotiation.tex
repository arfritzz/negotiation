...
\begin{enumerate}
\item A request is sent by the Appraiser to the Target. 
\item The Target receives the request and generates a set of protocols also known as a proposal. Each protocol must satisfy the Target's privacy policy. 
